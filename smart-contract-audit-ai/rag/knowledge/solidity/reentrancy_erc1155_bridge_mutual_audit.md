...
I will add some links with very good documentation and guides on how to write code and think about dos and don’ts in the blockchain environment.
    ...
    One of the best resources is Diligence’s very own Ethereum Smart Contract Security Best Practices. An article that is related to an uncovered issue describes push vs pull mechanisms and how to implement them.
    Another very useful guide is Solidity’s Common Patterns
    The Smart Contract Weakness Classification is also a great tool to understand the different security issues, check examples, references and recommendations for remediation.
